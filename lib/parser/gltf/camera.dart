import 'package:defend_the_donut/parser/gltf/camera_orthographic.dart';
import 'package:defend_the_donut/parser/gltf/camera_perspective.dart';
import 'package:defend_the_donut/parser/gltf/camera_type.dart';
...
class Camera extends GltfNode {
  ...
  Camera.parse(
    ...
    Map<String, Object?> map,
          ...
          orthographic: Parser.object(root, map, 'orthographic', CameraOrthographic.parse),
          perspective: Parser.object(root, map, 'perspective', CameraPerspective.parse),
        );
